...
import painting2 from "../assets/paintings/burjkhalifa.jpg";
import painting3 from "../assets/paintings/forest.jpeg";
import painting4 from "../assets/paintings/sunsets.jpg";
import painting5 from "../assets/paintings/coconut.jpeg";
import painting1 from "../assets/paintings/abstract.jpeg";

const paintings = [
  { img: painting1, label: "Abstract", medium: "Acrylic on Canvas" },
  { img: painting2, label: "Burj Khalifa", medium: "Gouache painting" },
  { img: painting3, label: "Enchanted by Sun", medium: "Acrylics on Canvas" },
  { img: painting4, label: "Sunset Dreams", medium: "Mixed Media" },
  { img: painting5, label: "Coconut for Summers", medium: "Watercolour" },
];
